...
export interface Translations {
  ...
  saveBeforeLeaveTitle: string
  saveBeforeLeaveMessage: string
  saveAndLeave: string
...
const translations: Record<Language, Translations> = {
  English: {
    ...
    habitCompletionRates: "Today's Habit Progress",
    ...
    supportMessage: 'If you have any questions, comments, or concerns, contact us.',
    supportContactButton: 'Contact Support',
    saveBeforeLeaveTitle: 'Save before you leave?',
    saveBeforeLeaveMessage: 'You have unsaved changes. Do you want to save before leaving?',
  ...
  Spanish: {
    ...
    habitCompletionRates: 'Progreso de hábitos de hoy',
    ...
    supportMessage: 'Si tienes preguntas, comentarios o inquietudes, contáctanos.',
    supportContactButton: 'Contactar Soporte',
    saveBeforeLeaveTitle: '¿Guardar antes de salir?',
    saveBeforeLeaveMessage: 'Tienes cambios sin guardar. ¿Quieres guardar antes de salir?',
  ...
  Dutch: {
    ...
    habitCompletionRates: 'Voortgang van vandaag',
    ...
    supportMessage: 'Voor vragen, opmerkingen of zorgen, neem contact met ons op.',
    supportContactButton: 'Contact Ondersteuning',
    saveBeforeLeaveTitle: 'Opslaan voordat je weggaat?',
    saveBeforeLeaveMessage: 'Je hebt niet-opgeslagen wijzigingen. Wil je opslaan voordat je weggaat?',
    saveAndLeave: 'Opslaan en weggaan',
    leaveWithoutSaving: 'Weggaan zonder opslaan',
    confirm: 'Bevestigen',
    info: 'Informatie',
  ...
  Danish: {
    ...
    habitCompletionRates: 'Dagens vanefremskridt',
    ...
    supportTitle: 'Support',
    supportMessage: 'Har du spørgsmål, kommentarer eller bekymringer, så kontakt os.',
    supportContactButton: 'Kontakt Support',
    saveBeforeLeaveTitle: 'Gem før du forlader?',
    saveBeforeLeaveMessage: 'Du har ugemte ændringer. Vil du gemme før du forlader?',
    saveAndLeave: 'Gem og forlad',
  ...
  Italian: {
    ...
    habitCompletionRates: 'Progresso abitudini di oggi',
    ...
    supportMessage: 'Per domande, commenti o dubbi, contattaci.',
    supportContactButton: 'Contatta Supporto',
    saveBeforeLeaveTitle: 'Salvare prima di uscire?',
    saveBeforeLeaveMessage: 'Hai modifiche non salvate. Vuoi salvare prima di uscire?',
